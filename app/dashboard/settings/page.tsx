    ...
    <div className="border-2 shadow-xl border-gray-200 dark:border-gray-800 rounded-2xl bg-gray-100 dark:bg-[#0f172a] text-gray-600 dark:text-gray-300 pt-4 md:p-5 md:pt-5 min-h-screen">
      <div className="mb-8 px-4 md:px-0">
        ...
        <p className="text-sm text-gray-400 dark:text-gray-500 mt-3">
          Kelola sistem, pembersihan data, dan konfigurasi lainnya.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-0">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-gray-100 dark:border-slate-700 shadow-sm opacity-50 grayscale">
          <h2 className="text-lg font-black text-gray-400 uppercase tracking-wider mb-6">Lainnya</h2>
          <p className="text-sm text-gray-400">Pengaturan tambahan akan ditambahkan di sini.</p>
        </div>
      </div>
    </div>
  );
