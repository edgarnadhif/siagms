...
export default function UnitClient({
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, statusFilter, projectFilter, showInactive]);
              ...
              <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-slate-700 w-full md:w-auto">
                ...
                <div className="relative" ref={projectRef}>
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-3.5 h-3.5 text-gray-400 transition-transform duration-200 ${projectDropdownOpen ? "rotate-180" : ""}`}
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-700/50">
                  {paginatedUnits.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center gap-2">
                          ...
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5-11.5L3 18.75V21h.75v-.75"
                            />
                          </svg>
                    ...
                    paginatedUnits.map((u) => (
                      <tr
                        key={u.id}
                        className={`hover:bg-gray-50/80 dark:hover:bg-slate-700/30 transition-all group ${u.isActive === false ? "opacity-50" : ""}`}
                      >
                            ...
                            {EDITABLE_STATUSES.includes(u.status) ? (
                              ...
                              <div className="relative group/tooltip">
                                ...
                                <div className="absolute bottom-full right-0 mb-2 hidden group-hover/tooltip:block w-52 bg-gray-900 dark:bg-slate-700 text-white text-[11px] font-medium px-2.5 py-1.5 rounded-lg shadow-xl z-50 whitespace-normal text-center pointer-events-none">
                                  Unit tidak dapat diedit karena sudah dalam
                                  proses transaksi
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <div className={readonlyCls}>
                        {editUnit.customer?.name || "—"}
                      </div>
                      {editUnit.customer && (
                        <p className="text-[10px] text-gray-400 mt-1">
                          Ubah pelanggan melalui fitur Assign/Unassign
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditForm({ ...editForm, blockName: e.target.value })
                      }
                      className={`${inputCls} ${editErrors.blockName ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`${inputCls} ${editErrors.unitNumber ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`${inputCls} ${editErrors.type ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                    {editErrors.type && (
                      <p className="text-xs text-red-500 mt-1">
                        {editErrors.type}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`${inputCls} ${editErrors.price ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                    {editErrors.price && (
                      <p className="text-xs text-red-500 mt-1">
                        {editErrors.price}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`${inputCls} ${editErrors.buildingArea ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`${inputCls} ${editErrors.landArea ? "border-red-400 focus:border-red-400" : ""}`}
                    />
                    {editErrors.landArea && (
                      <p className="text-xs text-red-500 mt-1">
                        {editErrors.landArea}
            ...
            <form onSubmit={handleAssign} className="p-6 space-y-5">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setAssignData({ customerId: e.target.value })
                  }
                  className={inputCls}
                >
                  ...
                  {customers.map((c) => (
                    <option key={c.id} value={c.id}>
                      {c.customerCode} - {c.name} ({c.paymentMethod})
                    </option>
                  ))}
                </select>
              </div>
